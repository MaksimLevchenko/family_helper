...
-- Indexes
CREATE UNIQUE INDEX "account_deletion_request_profile_id_idx" ON "account_deletion_request" USING btree ("profileId");

--
-- Class AppNotificationRow as table app_notification
--
...
-- Indexes
CREATE UNIQUE INDEX "app_profile_auth_user_id_idx" ON "app_profile" USING btree ("authUserId");
...
CREATE TABLE "calendar_event_override" (
    ...
    "overrideReminderOffsetMinutes" bigint,
    "overrideReminderCleared" boolean,
...
-- Indexes
CREATE UNIQUE INDEX "idempotency_key_actor_action_client_operation_idx" ON "idempotency_key" USING btree ("actorAuthUserId", "action", "clientOperationId");
...
-- Indexes
CREATE UNIQUE INDEX "money_contribution_goal_client_operation_idx" ON "money_contribution" USING btree ("goalId", "clientOperationId");
...
-- Indexes
CREATE UNIQUE INDEX "notification_preference_profile_type_idx" ON "notification_preference" USING btree ("profileId", "notificationType");
...
-- Indexes
CREATE UNIQUE INDEX "push_token_profile_token_idx" ON "push_token" USING btree ("profileId", "token");
...
--
-- Foreign relations for "account_deletion_request" table
--
...
--
-- Foreign relations for "app_profile" table
--
...
--
-- Foreign relations for "calendar_event_override" table
--
...
--
-- Foreign relations for "change_feed" table
--
...
--
-- Foreign relations for "family" table
--
...
--
-- Foreign relations for "family_invite" table
--
...
--
-- Foreign relations for "family_list" table
--
...
--
-- Foreign relations for "list_item" table
--
...
--
-- Foreign relations for "list_item_history" table
--
...
--
-- Foreign relations for "media_attachment" table
--
...
--
-- Foreign relations for "media_object" table
--
...
--
-- Foreign relations for "money_contribution" table
--
...
--
-- Foreign relations for "money_goal" table
--
...
--
-- Foreign relations for "privacy_export_job" table
--
...
--
-- Foreign relations for "push_token" table
--
...
--
-- Foreign relations for "task_history" table
--
